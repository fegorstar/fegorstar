...
## Projects
- **Address Verification Portal** — https://avr.percivaloaiya.com/  
  A robust address verification system designed to confirm the accuracy and validity of customer addresses.

- **Loan Application Platform** — https://www.nobleservefinance.com/  
  Streamlines applications for different loan types (personal, mortgage, business, etc.).

- **SaaS Mentorship Platform (Multi-tenant)** — https://hub.mentorsphir.com/  
  A multi-tenant mentoring application for managing mentorship programs across multiple organizations.

- **eHelp-Desk Platform** — https://csc.lasu.edu.ng/helpdesk/  
  Helps university visitors submit complaints/requests for streamlined communication and resolution.
...
## Contact Me
I’m available for freelance/contract work — let’s build something solid.
